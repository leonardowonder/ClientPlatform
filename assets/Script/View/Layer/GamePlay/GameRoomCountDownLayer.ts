...
@ccclass
export default class GameRoomCountDownLayer extends cc.Component {
    @property(cc.Label)
    ...
    init(time: number, pos: cc.Vec2) {
        ...
        this.m_countDownLabel.string = StringUtils.getInstance().formatByKey('game_play_count_down', this._curCountDown.toString());
    }
